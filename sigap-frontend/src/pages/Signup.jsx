                ...
                <div className="relative z-10 flex flex-col gap-8 max-w-xl">
                    ...
                    <div className="space-y-6">
                        ...
                        <h1 className="text-5xl font-bold leading-[1.1] tracking-tight text-white">
                            Join the future <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">of traffic AI.</span>
                        </h1>

                        <p className="text-lg text-slate-400 leading-relaxed max-w-md">
                            Create your account and start managing traffic with AI-powered insights, real-time monitoring, and predictive analytics.
                        </p>
                    </div>
                ...
                <div className="w-full max-w-[480px] relative z-10">
                    ...
                    <div className="bg-[#1a2333]/60 backdrop-blur-xl border border-white/5 rounded-2xl p-8 sm:p-10 shadow-2xl">
                        <div className="mb-8 text-center lg:text-left">
                            ...
                            <p className="text-slate-400">Sign up to start managing traffic intelligently.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <span className="material-symbols-outlined text-slate-500 group-focus-within:text-primary transition-colors text-[20px]">person</span>
                                    </div>
                                    <input
                                        id="fullName"
                                        type="text"
                            ...
                            {/* Email */}
                            <div className="space-y-2">
                                <label htmlFor="signupEmail" className="text-sm font-medium text-slate-300 ml-1">Email</label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            {/* Password */}
                            <div className="space-y-2">
                                <label htmlFor="signupPassword" className="text-sm font-medium text-slate-300 ml-1">Password</label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-slate-400 text-sm">
                                ...
                                <Link to="/login" className="text-primary hover:text-primary/80 font-medium ml-1 transition-colors">Log in</Link>
                            </p>
                        </div>
                    </div>
